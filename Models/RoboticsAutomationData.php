...
class RoboticsAutomationData {
    private $_id, $_course, $_coursedetails1, $_coursedetails2, $_coursedetails3, $_coursedetails4, 
          $_coursedetails5, $_entry, $_teaching, $_employability, $_feesandfunding, $_facilities;
