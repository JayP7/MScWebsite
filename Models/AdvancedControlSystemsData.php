...
class AdvancedControlSystemsData {
   private $_id, $_course, $_coursedetails, $_coursedetails1, $_coursedetails2, $_coursedetails3, 
           $_coursedetails4, $_coursedetails5, $_coursedetails6, $_coursedetails7, 
           $_coursedetails8, $_coursedetails9, $_coursedetails10, $_coursedetails11, $_coursedetails12, $_entry, 
           $_teaching, $_employability, $_feesandfunding, $_facilities;
  ...
  public function __construct($dbRow) {
    ...
    $this->_coursedetails10 = $dbRow['coursedetails10'];
    $this->_coursedetails11 = $dbRow['coursedetails11'];
    $this->_coursedetails12 = $dbRow['coursedetails12'];
...
public function getcoursedetails10() {
    return $this->_coursedetails10;
}

public function getcoursedetails11() {
    return $this->_coursedetails11;
}

public function getcoursedetails12() {
    return $this->_coursedetails12;
}
